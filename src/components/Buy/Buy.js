...
class Buy extends Component{
    ...
    render(){
        ...
        /> </Tab.Pane> },
            { menuItem: 'Wings', render: () => <Tab.Pane><DiyList
                category = {this.state.wings}
                info = {this.state.info}
                selectParts = {this.selectParts}
                /></Tab.Pane> },
            { menuItem: 'Frame', render: () => <Tab.Pane><DiyList
                category = {this.state.frame}
                info = {this.state.info}
                selectParts = {this.selectParts}
                /></Tab.Pane> },
            { menuItem: 'Control Board', render: () => <Tab.Pane><DiyList
                category = {this.state.cb}
                info = {this.state.info}
                selectParts = {this.selectParts}
                /></Tab.Pane> },
            { menuItem: 'ESC', render: () => <Tab.Pane><DiyList
                category = {this.state.esc}
                info = {this.state.info}
                selectParts = {this.selectParts}
                /></Tab.Pane> },
            { menuItem: 'Battery', render: () => <Tab.Pane><DiyList
                category = {this.state.battery}
                info = {this.state.info}
                selectParts = {this.selectParts}
                /></Tab.Pane> },
            { menuItem: 'Antenna', render: () => <Tab.Pane><DiyList
